...
{
	// ! combination of SendSceneDataToGPU and  CreateVBO in Main.cpp
	// ! 1.1.2.	Take a few moments to examine how the VAO, the VBO, _arraySize, and _objectData are being used
...
{
	// ! 1.2.1.	Take note of how _shaderProgramId and _arraySize are being used
	glBindVertexArray(_vaoId);
